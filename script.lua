    ...
    CombatTab:Toggle({
        ...
        Callback = function(state)
            ...
            -- ✔ ON = n’attaque pas les amis
            -- ✔ OFF = recommence automatiquement à les frapper
                ...
                if wheelsFolder then
                    for _, wheel in ipairs(wheelsFolder:GetChildren()) do
                        if wheel:IsA("BasePart") then
                            -- Sauvegarde les welds pour recoller après
...
TpPointTab:Button({ 
    Title = "Middle Prison Parking", 
    Desc = "Tp to middle prsion parking", 
    Locked = false,
    Callback = function()
...
TpPointTab:Button({ 
    Title = "Police Armory", 
    Desc = "Tp to Police Armory", 
    Locked = false,
    Callback = function()
        TpOverload(Vector3.new(830, 100, 2236))
    end
})

TpPointTab:Button({ 
    Title = "Front Police Room", 
    Desc = "Tp to Front Police Room", 
    Locked = false,
    Callback = function()
        TpOverload(Vector3.new(826, 100, 2354))
    end
})

TpPointTab:Button({ 
    Title = "Prison Cell", 
    Desc = "Tp to Prison Cell", 
    Locked = false,
    Callback = function()
        TpOverload(Vector3.new(826, 100, 2354))
    end
...
TpPointTab:Button({ 
    Title = "Inside Police Parking", 
    Desc = "Tp to Police Parking", 
    Locked = false,
    Callback = function()
        TpOverload(Vector3.new(616, 98, 2495))
    end
})

TpPointTab:Button({ 
    Title = "Safe Spot", 
    Desc = "Tp to Safe Spot", 
    Locked = false,
    Callback = function()
        TpOverload(Vector3.new(-611, 11, 1417))
    end
})
